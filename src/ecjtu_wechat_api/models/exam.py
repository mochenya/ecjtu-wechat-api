...
class ExamItem(BaseModel):
    ...
    exam_date: str = Field(..., description="考试日期，如 '2026年01月08日'")
    day_of_week: str = Field(..., description="星期几，如 '星期四'")
    time_range: str = Field(..., description="考试时间段，如 '14:00-16:00'")
    time_start: str = Field(..., description="考试开始时间，如 '14:00'")
    time_end: str = Field(..., description="考试结束时间，如 '16:00'")
    ...
    note: str | None = Field(default=None, description="考试备注（红色提示文字）")
